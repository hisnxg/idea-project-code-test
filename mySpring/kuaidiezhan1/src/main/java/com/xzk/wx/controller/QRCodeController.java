...
public class QRCodeController {
     ...
     * @return
     */
    @RequestMapping("/wx/createQRCode.do")

    public ModelAndView createQRCode(HttpServletRequest req, HttpServletResponse resp){
        ...
        return new ModelAndView("personQRcode.html");
    }

    @RequestMapping("/wx/qrcode.do")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping("/wx/updataStatus.do")
    @ResponseBody
